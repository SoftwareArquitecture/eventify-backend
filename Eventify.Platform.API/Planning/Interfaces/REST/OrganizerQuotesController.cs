...
[Tags("Organizers")]
public class OrganizerQuotesController(IQuoteQueryService quoteQueryService, IQuoteCommandService quoteCommandService):ControllerBase
{
    [HttpGet]
    ...
    [HttpPost]
    [SwaggerOperation(Summary = "Creates a new quote for organizer", Description = "Creates a new quote for the specified organizer and returns the created quote resource", OperationId = "CreateQuoteForOrganizer")]
    ...
    public async Task<IActionResult> CreateQuoteForOrganizer([FromRoute] int organizerId, [FromBody] CreateQuoteResource resource)
    {
    ...
    [HttpPut("{quoteId}")]
    [SwaggerOperation(Summary = "Updates a quote for organizer", Description = "Updates a quote for the specified organizer", OperationId = "UpdateQuoteForOrganizer")]
    ...
    public async Task<IActionResult> UpdateQuoteForOrganizer([FromRoute] int organizerId, [FromRoute] string quoteId, [FromBody] UpdateQuoteResource resource)
    {
