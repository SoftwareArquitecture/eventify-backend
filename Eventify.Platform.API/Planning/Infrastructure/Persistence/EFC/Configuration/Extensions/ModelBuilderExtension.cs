...
public static class ModelBuilderExtension
{
      public static void ApplyPlanningConfiguration(this ModelBuilder builder)
      {
            ...
            builder.Entity<TaskItem>().Property(t => t.Id).IsRequired().HasConversion(taskIdConverter).ValueGeneratedOnAdd();
            builder.Entity<TaskItem>().Property(t => t.Title).IsRequired().HasConversion(taskTitleConverter).HasColumnName("Title").HasMaxLength(200);
            builder.Entity<TaskItem>().Property(t => t.Description).HasConversion(taskDescriptionConverter).HasColumnName("Description").HasMaxLength(1000);
            builder.Entity<TaskItem>().Property(t => t.ColumnId).IsRequired().HasConversion(taskColumnIdConverter).HasColumnName("ColumnId");
            builder.Entity<TaskItem>().Property(t => t.Order).IsRequired().HasConversion(taskOrderConverter).HasColumnName("TaskOrder");
            builder.Entity<TaskItem>().Property(t => t.CreatedAt).IsRequired().HasColumnName("CreatedAt").HasColumnType("datetime");
            builder.Entity<TaskItem>().Property(t => t.UpdatedAt).IsRequired().HasColumnName("UpdatedAt").HasColumnType("datetime");
      }
}